...
void Binary_Tree::addChapter(string chapter_name)
{
    ...
    else
    {
        ...
        else
        {
            ...
            {//Chapter is Not present so adding in the last position in the Book
            ...
            {   //Chapter Found
                ...
                if(Section == NULL)  //Adding First Section
                  ...
                  {  //Search Section
                    ...
                    if(Section == NULL) //Section not present adding in last
                    {//Chapter is Not present so adding in the last position in the Book
                ...
                {//search section
                  ...
                  {   //Section found
                    ...
                    {//Search subsection
                        ...
                        if(subSection == NULL)
                        {//Sub Section is Not present so adding in the last
...
int main()
{
    ...
    do{
        ...
        cout<<"1. Add Chapter    "<<endl<<"2. Add Section    "<<endl
            <<"3. Add Sub-Section"<<endl<<"4. Display        "<<endl
            <<"5. Exit           "<<endl;
