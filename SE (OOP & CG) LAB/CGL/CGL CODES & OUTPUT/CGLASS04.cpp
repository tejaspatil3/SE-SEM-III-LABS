//PRACTICAL Assignment No:04 {Computer Graphics}
// Roll No:205B065
/* a) Write C++ program to draw 2-D object and perform following basic
   transformations, Scaling b) Translation c) Rotation. Apply the concept of operator
   overloading.
                              OR
   b) Write C++ program to implement translation, rotation and scaling
   transformations on equilateral triangle and rhombus. Apply the concept of operator
   overloading.*/
...
void printOriginalTriangle(int x1, int y1, int x2, int y2, int x3, int y3)
{
    line(x1, y1, x2, y2);
    line(x2, y2, x3, y3);
    line(x1, y1, x3, y3);
...
int gd=DETECT,gm=0;
int ch;
int x1=100,y1=100,x2=300,y2=100,x3=150,y3=50,tx=40,ty=40;
int a1=100,b1=100,a2=300,b2=100,a3=150,b3=50,sx=1,sy=2;
...
case 3:
initgraph(&gd,&gm,"c://turboc3/bgi");
printOriginalTriangle(x1, y1, x2, y2, x3, y3);
t1.setvalue(x1);
t2.setvalue(y1);
t3.setvalue(x2);
t4.setvalue(y2);
