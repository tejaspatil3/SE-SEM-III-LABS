//Assignment No:03 {Object Oriented Programming}
...
# include<stdio.h>
using namespace std;
class publication // declaring class Publica􀆟on
{
private:
string title;
float price;
...
class book : public publication // declaring class book which inherits class publica􀆟on in public mode.
{
private:
int page_count;
public:
...
class tape : public publication // declaring class tape which inherits class publicaion in public mode
{
private:
float play_time;
public:
